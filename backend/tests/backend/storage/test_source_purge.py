...
def test_every_direct_storage_delete_call_site_is_on_the_known_allowlist():
    ...
    app_root = Path(__file__).resolve().parent.parent.parent.parent / "app"
...
def test_apply_runtime_privileges_verifies_return_type_and_language():
    ...
    policy_path = _Path(__file__).resolve().parent.parent.parent.parent / "scripts" / "security" / "s1a_privilege_policy.py"
...
def _load_policy_module(name: str):
    policy_path = Path(__file__).resolve().parent.parent.parent.parent / "scripts" / "security" / "s1a_privilege_policy.py"
